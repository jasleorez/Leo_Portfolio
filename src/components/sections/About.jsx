        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center">
              <img src="https://github.com/jasleorez/Leo_Portfolio/blob/main/assets/Leo.jpeg?raw=true" alt="Leo's Profile Picture" className="rounded-3 w-full max-w-xs mx-auto shadow-lg shadow-[#0b3d25]" />
            </div>
          </div>
